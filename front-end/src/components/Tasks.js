          ...
          <div className="d-flex align-items-center gap-3 mt-2">
            ...
            <div
              className={`btn fw-bold p-2 pt-1 pb-1 ${
                IsClicked.active ? "btn-warning" : "btn-outline-warning"
              }`}
              style={{ fontSize: "12px" }}
              onClick={() => {
                setFilterByActive((p) => !p);
                setIsClicked((p) => ({ ...p, active: !p.active }));
              }}
            >
              Active
            </div>
            <div
              className={`btn fw-bold p-2 pt-1 pb-1 ${
                IsClicked.impo ? "btn-danger" : "btn-outline-danger"
              }`}
              style={{ fontSize: "12px" }}
              onClick={() => {
                setFilterByEmergency((p) => !p);
                setIsClicked((p) => ({ ...p, impo: !p.impo }));
              }}
            >
              Important
            </div>
            <div
              className={`btn fw-bold p-2 pt-1 pb-1 ${
                IsClicked.done ? "btn-success" : "btn-outline-success"
              }`}
              style={{ fontSize: "12px" }}
              onClick={() => {
                setFilterByCompletion((p) => !p);
                setIsClicked((p) => ({ ...p, done: !p.done }));
              }}
            >
              Completed
            </div>
            ...
            {Tasks.length !== 0
                  ...
                  >
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      >
                        <Checkbox
                          color="success"
                          onClick={(e) => handleChangeTaskDone(e, task._id)}
                          checked={task.isDone}
                        />
                        {StartEdit && captureI === i ? (
                          <div className="d-flex align-items-center gap-3">
                            ...
                            <div className="d-flex gap-2 ">
                              <button
                                onClick={() => handleChangeTaskText(task._id)}
                                style={{ fontSize: "12px" }}
                                className="btn btn-outline-success p-2 pt-1 pb-1"
                              >
                                Save
                              </button>
                              <button
                          ...
                          >
                            ...
                            <Checkbox
                              onClick={(e) =>
                                handleChangeTaskImportant(e, task._id)
                              }
                      ...
                      <div className="d-flex gap-2" style={{ width: "15%" }}>
                        {task.isDone ? (
                          ...
                          <span
                            className="btn btn-warning fw-bold p-2 pt-1 pb-1 rounded"
                            style={{ fontSize: "12px", cursor: "default" }}
                          >
                            Active
                          </span>
                        ...
                        {task.isImportant && (
                          <span
                            className="btn btn-danger fw-bold p-2 pt-1 pb-1 rounded"
                            style={{ fontSize: "12px", cursor: "default" }}
                          >
                            Important
                          </span>
                      ...
                      <div className="actionButtons">
                        <i
                          className="btn btn-outline-danger p-2 border-0 bi bi-trash3-fill"
              ...
              : clickedCateg !== "" && (
                  ...
                  >
                    ...
                    <p className="no-content">No Tasks Available</p>
                  </div>
                )}
          </div>
          <Fab
            ...
            onClick={() => dispatch({ type: "showTaskForm" })}
          >
            <AddIcon />
          </Fab>
        </div>
